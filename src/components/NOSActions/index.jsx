...
class NOSActions extends Component {
	handleAlert = async func => console.log(await func);
		...
		return (
			<React.Fragment>
				<button
					...
					onClick={() => this.handleAlert(nos.getAddress())}
				>
					Get Address
				</button>
				<button
				...
				<button
					className={classes.button}
					onClick={() => this.handleAlert(nos.testInvoke(invoke))}
				>
					TestInvoke
				</button>
				{/*
